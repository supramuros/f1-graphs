...
export default function RelativePositionGap(props:AppState){
    ...
    return (
        <div className='grid-container'>
            ...
            <div className='main'>
                <BarGraph
                        data={props.driverList.flatMap(d=>
                            driverMap.get(d.driverId).laps.filter(f=>f.lapNum>0).map(l=>(
                            {
                                key:d.driverId,
                                disabled:!d.enabled,
                                x:l.lapNum,
