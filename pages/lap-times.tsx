...
export default function LapTimes(props:AppState){
    ...
    return (
        <div className='grid-container'>
            ...
            <div className='main'>
                <BarGraph
                        data={props.lap&&props.lap>0&&props.lap<raceDetails.numLaps
                            ?singleLapData.map(d=>(
                            {
                                key:d.driverId,
                                disabled:d.disabled,
                        ...
                        :props.driverList.map(d=>(
                            {
                                ...
                                xLabel:driverMap.get(d.driverId).driver.driverCode,
                                color:driverMap.get(d.driverId).driver.constructorColor,
                                y:driverMap.get(d.driverId).raceStats.avgLapNetPitTime
                            }
                        )).filter(f=>f.y>0)
                        }
            ...
            <div className='right-column'>
                ...
                <div id='right-bottom-graph-title'>
                    {props.driver?driverMap.get(props.driver).driver.driverCode+' LAP TIMES':''}
                </div>
                <div className='right-bottom-column'>
                    {props.driver?
                        <ScatterGraph
                            ...
                            {
                                seriesKey:d.driverId,
                                series:driverMap.get(d.driverId).laps.filter(fl=>fl.lapNum>0&&fl.lapNum<=raceDetails.numLaps)
                                    .map(l=>({
                                    key:l.driverId,
                                    x:l.lapNum,
