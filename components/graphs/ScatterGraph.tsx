...
import { Hint, FlexibleXYPlot, XAxis, YAxis, VerticalGridLines, HorizontalGridLines,MarkSeries, Borders} from 'react-vis';
import '../../node_modules/react-vis/dist/style.css';
import { GraphData } from '../../types/GraphTypes';
/*
*   Displays a scatter graph with marks for each series
*/
...
export default function ScatterGraph(
    ...
    */
    ...
    data.flatMap(x=>x.series).forEach(v=>{
